    ...
    const mailOptionsToApplicant = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
          ...
          <p>This is a system-generated email to confirm that we have received your application for the position of <strong>${job_title}</strong> at Job Vortex.</p>
          
          <p>Our recruitment team will review your resume. If you are shortlisted for an interview or if we require additional information, a recruiter will reach out to you.</p>
      
          <p><strong>We aim to provide an update on your application within three weeks.</strong></p>
      
          <p>If you have any questions in the meantime, feel free to contact us at career@jobvortex.com.</p>
